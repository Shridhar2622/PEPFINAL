                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 stagger-item">
                        ...
                        <div className="mb-2">
                            ...
                            <div className="flex gap-3">
                                <label className={`flex-1 border rounded-lg p-2 cursor-pointer transition-colors ${role === 'USER' ? 'border-rose-600 bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-400' : 'border-slate-200 dark:border-slate-700 hover:border-rose-300 dark:hover:border-rose-700'}`}>
                                ...
                                <label className={`flex-1 border rounded-lg p-2 cursor-pointer transition-colors ${role === 'TECHNICIAN' ? 'border-rose-600 bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-400' : 'border-slate-200 dark:border-slate-700 hover:border-rose-300 dark:hover:border-rose-700'}`}>
                                    <div className="flex items-center gap-2 font-bold text-xs">
                                        <input
                                            type="radio"
                                            name="role"
