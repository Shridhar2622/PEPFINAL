                ...
                <form onSubmit={handleSubmit} className="p-5 md:p-8 space-y-6 md:space-y-8">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="relative w-24 h-24 md:w-32 md:h-32 mb-4">
                            ...
                            <label className="absolute bottom-0 right-0 bg-rose-600 text-white p-2 rounded-full cursor-pointer hover:bg-rose-700 shadow-md transition-colors">
                    ...
                    <div>
                        ...
                        <textarea
                            rows="4"
                            className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border-transparent focus:border-rose-500 focus:bg-white dark:focus:bg-slate-800 focus:ring-0 transition-all resize-none"
                    ...
                    <div className="pt-4">
                        <Button
                            type="submit"
                            className="w-full py-4 text-lg shadow-xl shadow-rose-600/20"
