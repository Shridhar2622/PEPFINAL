...
const MaintenancePage = ({ message, endTime }) => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            {/* Glowing Orbs */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-rose-600/10 rounded-full blur-[120px] pointer-events-none animate-pulse" />
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-600/10 rounded-full blur-[120px] pointer-events-none animate-pulse"
            ...
            >
                ...
                >
                    ...
                    <div className="absolute inset-0 border-2 border-dashed border-rose-500/30 rounded-full animate-pulse" />
                </motion.div>

                {/* Title */}
                <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tighter uppercase italic line-height-[0.9]">
                    Under <span className="bg-gradient-to-r from-rose-400 to-orange-500 bg-clip-text text-transparent">Maintenance</span>
                </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                    {[
                        ...
                        { icon: Clock, label: "90% Complete", color: "text-rose-500" },
                        { icon: Mail, label: "Support Open", color: "text-orange-500" }
                    ].map((feature, i) => (
