            ...
            <div className="w-full max-w-md login-card">
                ...
                <div className="text-center mb-8 stagger-item">
                    <Link to="/" className="inline-flex items-center gap-2.5 mb-6">
                        ...
                        <span className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Reservice<span className="text-rose-600">Pro</span></span>
                    </Link>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 md:p-10 shadow-2xl shadow-blue-500/5 border border-slate-100 dark:border-slate-800 stagger-item">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-5 bg-rose-600 text-white rounded-3xl font-black text-sm uppercase tracking-[0.2em] shadow-xl shadow-rose-500/25 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-70"
                        >
                ...
                <div className="mt-8 text-center stagger-item">
                    ...
                    <Link to="/partner/register" className="mt-2 inline-block text-rose-600 font-black text-sm hover:underline decoration-2 underline-offset-4">
